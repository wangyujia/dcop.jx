...
public class LanAppService implements ILanApp, Runnable {
    ...
    private String m_appName = "LanApp";
    ...
    /// 事件接收器
    private ILanEvent m_recver = null;
    ...
    @Override
    public void run() {
        Logs.record("trace", String.format("LanAppService Task('%s') Start Running ...", m_appName));
        ...
        Logs.record("trace", String.format("LanAppService Task('%s') Stop Running!", m_appName));
    }
    ...
    /// 通道和远程集合的MAP
    private Map<Integer, Channel> m_channels;
    private Map<Integer, Channel> m_remotes;


    /// 公共初始化块
    {
        m_channels = new TreeMap<Integer, Channel>();
        m_remotes  = new TreeMap<Integer, Channel>();
    }
